<link rel="stylesheet" type="text/css" href="http://www.freeformatter.com/css/freeformatter.css" />
<link rel="stylesheet" type="text/css" href="http://www.freeformatter.com/css/bootstrap.min.css" />
<style>
table, p, h2 {
	width: 500px;
	margin: 0 auto;
...
<div id="ascii-characters">
					...
					<table class="bordered-table zebra-striped" style="font-size:11px;">
						<thead>
							<tr>
...
<div id="iso88591-characters">
				...
				<div id="iso88591-symbols">
					...
					<table class="bordered-table zebra-striped" style="font-size:11px;">
						...
						<tbody>
							...
							<tr><td>&#186;</td><td>&amamp;ordm;</td><td>&amp;#186;</td><td>Masculine ordinal indicator</td></tr>
				...
				<div id="math-symbols">
					...
					<table class="bordered-table zebra-striped" style="font-size:11px;">
						...
						<tbody>
							...
							<tr><td>&#8836;</td><td>&amp;nsub;</td><td>&amp;#8836;</td><td>Not subset of</td></tr>																					
							<tr><td>&#8838;</td><td>&amp;sube;</td><td>&amp;#8838;</td><td>Subset or equal</td></tr>
				...
				<div id="misc-html-entities">
					<h2 style="margin:20px 0 10px 0">Miscellaneous HTML entities</h2><p>List of miscellaneous HTML entities.</p><table class="bordered-table zebra-striped" style="font-size:11px;">
						<thead>
							<tr>
								<th nowrap="nowrap">Symbol</th>
								<th nowrap="nowrap">Entity Name</th>
...
?è?							<tr><td>&#8211;</td><td>&amp;ndash;</td><td>&amp;#8211;</td><td>En dash</td></tr> 
